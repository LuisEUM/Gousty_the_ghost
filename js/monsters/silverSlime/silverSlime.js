class SilverSlimes {
    ...
    draw() {
        //silverBullet dibujado de proyectiles
        this.silverBullets.forEach((silverBullet) => {
            silverBullet.draw();
          });
    ...
    move(player) {
        ...
        //silverBullet movimiento de proyectiles 
        this.silverBullets.forEach((silverBullet) => {
        silverBullet.move();
        });
    ...
    shoot(player) {
        const silverBullet = new SilverBullets(
        this.ctx,
        player,
        this.x + this.w,
        this.y + this.h
        );
        this.silverBullets.push(silverBullet);
    }
